...
const WeatherDetails = ({ data }: WeatherDetailsProps) => {
  ...
  return (
    <div className="p-12">
      <h1 className="mb-4 text-4xl text-white italic font-extrabold drop-shadow-xl animate-bounce 1s infinite">
        Info Cuaca Terkini
      </h1>

      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 text-center italic font-bold">
        <div className="text-white/100 bg-black/40 flex p-4 items-center justify-center gap-6 rounded-xl">
          <div className="text-2xl">
            <h3>Kecepatan Angin</h3>
            <h3
              className="text-white/100 bg-white/20 rounded-xl mt-1"
        ...
        <div className="text-white/100 bg-black/40 flex p-4 items-center justify-center gap-6 rounded-xl">
          <div className="text-2xl">
            <h3>Terbit Matahari</h3>
            <h3
              className="text-white/100 bg-white/20 rounded-xl mt-1 px-2"
